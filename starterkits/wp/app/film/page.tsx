...
import ArchiveParams from './ArchiveParams';
import filmArchiveQuery from './filmArchiveQuery';

const PAGE_TITLE = 'Films';
export const metadata: Metadata = {
  title: PAGE_TITLE,
};

interface FilmArchiveProps extends NextSearchParamsProp {}

async function FilmArchive({ searchParams }: FilmArchiveProps) {
