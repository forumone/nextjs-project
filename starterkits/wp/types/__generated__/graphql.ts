...
/** Input for the createFilm mutation. */
...
/** The payload for the createFilm mutation. */
...
export type CustomBlockLibraryAwardWinnerAttributes = {
  __typename?: 'CustomBlockLibraryAwardWinnerAttributes';
  /** The &quot;backgroundId&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  backgroundId: Scalars['Float']['output'];
  /** The &quot;backgroundSrc&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  backgroundSrc: Scalars['String']['output'];
  /** The &quot;className&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  className?: Maybe<Scalars['String']['output']>;
  /** The &quot;filmId&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  filmId: Scalars['Float']['output'];
  /** The &quot;filmImageSrc&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  filmImageSrc: Scalars['String']['output'];
  /** The &quot;filmTitle&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  filmTitle: Scalars['String']['output'];
  /** The &quot;introText&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  introText: Scalars['String']['output'];
  /** The &quot;lock&quot; field on the &quot;CustomBlockLibraryAwardWinnerAttributes&quot; block or block attributes */
  lock?: Maybe<Scalars['BlockAttributesObject']['output']>;
};
...
export type CustomBlockLibraryFeaturedFilmsAttributes = {
  __typename?: 'CustomBlockLibraryFeaturedFilmsAttributes';
  /** The &quot;className&quot; field on the &quot;CustomBlockLibraryFeaturedFilmsAttributes&quot; block or block attributes */
  className?: Maybe<Scalars['String']['output']>;
  /** The &quot;lock&quot; field on the &quot;CustomBlockLibraryFeaturedFilmsAttributes&quot; block or block attributes */
  lock?: Maybe<Scalars['BlockAttributesObject']['output']>;
};
...
export type CustomBlockLibraryFeaturedTextListAttributes = {
  __typename?: 'CustomBlockLibraryFeaturedTextListAttributes';
  /** The &quot;className&quot; field on the &quot;CustomBlockLibraryFeaturedTextListAttributes&quot; block or block attributes */
  className?: Maybe<Scalars['String']['output']>;
  /** The &quot;lock&quot; field on the &quot;CustomBlockLibraryFeaturedTextListAttributes&quot; block or block attributes */
  lock?: Maybe<Scalars['BlockAttributesObject']['output']>;
  /** The &quot;title&quot; field on the &quot;CustomBlockLibraryFeaturedTextListAttributes&quot; block or block attributes */
  title?: Maybe<Scalars['String']['output']>;
};
...
export type CustomBlockLibraryFilmSelectorAttributes = {
  __typename?: 'CustomBlockLibraryFilmSelectorAttributes';
  /** The &quot;className&quot; field on the &quot;CustomBlockLibraryFilmSelectorAttributes&quot; block or block attributes */
  className?: Maybe<Scalars['String']['output']>;
  /** The &quot;filmId&quot; field on the &quot;CustomBlockLibraryFilmSelectorAttributes&quot; block or block attributes */
  filmId: Scalars['Float']['output'];
  /** The &quot;filmImageSrc&quot; field on the &quot;CustomBlockLibraryFilmSelectorAttributes&quot; block or block attributes */
  filmImageSrc: Scalars['String']['output'];
  /** The &quot;filmTitle&quot; field on the &quot;CustomBlockLibraryFilmSelectorAttributes&quot; block or block attributes */
  filmTitle: Scalars['String']['output'];
  /** The &quot;lock&quot; field on the &quot;CustomBlockLibraryFilmSelectorAttributes&quot; block or block attributes */
  lock?: Maybe<Scalars['BlockAttributesObject']['output']>;
};
...
/** Input for the deleteFilm mutation. */
...
/** The payload for the deleteFilm mutation. */
...
export type Film = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithEditorBlocks & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithFilmEditorBlocks & NodeWithPageAttributes & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  /** The desired slug of the post */
  desiredSlug?: Maybe<Scalars['String']['output']>;
  /** The person who directed this film. */
  ...
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  /** A selected quote from the movie. */
  quote?: Maybe<Scalars['String']['output']>;
  /** The selected quotes attribution */
...
/** Connection to film Nodes */
export type FilmConnection = {
  /** A list of edges (relational context) between RootQuery and connected film Nodes */
  edges: Array<FilmConnectionEdge>;
  /** A list of connected film Nodes */
  nodes: Array<Film>;
  /** Information about pagination in a connection. */
  pageInfo: FilmConnectionPageInfo;
};

/** Edge between a Node and a connected film */
export type FilmConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected film Node */
  node: Film;
};

/** Page Info on the connected FilmConnectionEdge */
export type FilmConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** EditorBlock Interface for Film Block Type */
export type FilmEditorBlock = {
  /** The API version of the Gutenberg Block */
  apiVersion?: Maybe<Scalars['Int']['output']>;
  /** The name of the category the Block belongs to */
  blockEditorCategoryName?: Maybe<Scalars['String']['output']>;
...
export enum MenuLocationEnum {
  ...
  Secondary = 'SECONDARY',
  /** Put the menu in the social-media location */
...
export type RootQuery = {
  ...
  films?: Maybe<RootQueryToFilmConnection>;
  /** Returns the contact information intended to be housed in the website&#039;s footer */
  footerContactInformation?: Maybe<Scalars['String']['output']>;
...
/** Input for the updateFilm mutation. */
...
/** The payload for the updateFilm mutation. */
